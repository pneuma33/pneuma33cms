...
function cabbagecms_dashboard() { // populate dashboard widget
    ...
    echo '<p>Welcome to your Pneuma33 CMS administration panel. From here, you can manage your Pneuma33 site. If you require assistance, please visit <a href="https://pneuma33.com/"> morecabbage.net</a> and submit a support ticket. Our knowledgeable and friendly staff will quickly respond to your request. You may also email the support staff at <a href="mailto:friendlysupport@pneuma33.com">friendlysupport@pnuema33.com</a>. Thank you for choosing Pneuma33.</p>';
